...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/usercus_findbypage.action"
		method=post>
									...
									<TD>
										<TABLE id=grid
											...
											<TBODY>
												...
												<c:forEach items="${page.list}" var="usercus">
												<TR
													style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
													<TD>${usercus.customer.cust_name }</TD>
													<TD>${usercus.visit_time }</TD>
													<TD>${usercus.visit_interviewee }</TD>
													<TD>${usercus.visit_addr }</TD>
													<TD>${usercus.visit_detail }</TD>
													<TD>${usercus.visit_nexttime }</TD>
												</TR>
