...
<script type="text/javascript">
	$(function(){
		...
		$.post(url,function(data){
			$(data).each(function(){
				$("#cusname").append("<option value='"+this.cust_id+"'>"+this.cust_name+"</option>");
			});
		},"json")
...
<BODY>
	<FORM id=form1 name=form1 action="${pageContext.request.contextPath }/usercus_save.action" method=post>
